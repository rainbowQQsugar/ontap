...
public class Joiner {
    ...
    private Joiner(String separator) {
        this.separator = GuavaUtils.checkNotNull(separator);
    }
    ...
    public <A extends Appendable> A appendTo(A appendable, Iterator<?> parts) throws IOException {
        GuavaUtils.checkNotNull(appendable);
        if (parts.hasNext()) {
    ...
    public Joiner useForNull(final String nullText) {
        GuavaUtils.checkNotNull(nullText);
    ...
    public Joiner skipNulls() {
        return new Joiner(this) {
            @Override
            public <A extends Appendable> A appendTo(A appendable, Iterator<?> parts) throws IOException {
                GuavaUtils.checkNotNull(appendable, "appendable");
                GuavaUtils.checkNotNull(parts, "parts");
                while (parts.hasNext()) {
    ...
    public static final class MapJoiner {
        ...
        private MapJoiner(Joiner joiner, String keyValueSeparator) {
            this.joiner = joiner; // only "this" is ever passed, so don't GuavaUtils.checkNotNull
            this.keyValueSeparator = GuavaUtils.checkNotNull(keyValueSeparator);
        }
    ...
    CharSequence toString(Object part) {
        GuavaUtils.checkNotNull(part); // GuavaUtils.checkNotNull for GWT (do not optimize).
        return (part instanceof CharSequence) ? (CharSequence) part : part.toString();
    }

    private static Iterable<Object> iterable(
            final Object first, final Object second, final Object[] rest) {
        GuavaUtils.checkNotNull(rest);
