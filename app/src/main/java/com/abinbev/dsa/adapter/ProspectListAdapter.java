...
public class ProspectListAdapter extends BaseAdapter {
    ...
    public interface AccountClickHandler {
        void onAccountClick(String accountId, String status);
    }

    private final List<Account> accounts;
    private final AccountClickHandler accountClickHandler;

    public ProspectListAdapter(AccountClickHandler accountClickHandler) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.status.setText(account.getTranslatedProspectStatus());
        viewHolder.leadSource.setText(account.getTranslatedLeadSource());
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                accountClickHandler.onAccountClick(account.getId(), account.getTranslatedProspectStatus());
            }
        });
